...
**reading_csv** - Функция реализующая считывание данных из csv-файла и возвращающая
их в виде списка словарей.

**reading_excel** - Функция считывающая данные таблицы из excel-файла и возвращающая
их в качестве списка словарей.
...
В модуле `test_reading.py` хранятся тесты:
   - `test_reading_csv` - проверяет считывание данных csv-файла.
   - `test_reading_excel` - тестируется сбор данных из таблицы excel-файла.
...
1. Реализован новый функционал по считыванию данных о финансовых операциях из csv- и excel- файлов.
2. Написаны тесты для новых функций.
