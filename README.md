...
1. Добавлено логирование для модулей `masks.py` и `utils.py`. Отчёты по логированию сохраняются с методом перезаписи
в файлы `masks.log` и `utils,log` соответственно.
2. Отредактирован файл `README.md`, добавлено описание, в том числе для тестирования.